...
function _addRequest(span, entry, timeOrigin) {
  if (entry.responseEnd) {
    ...
    utils.startAndEndSpan(
      span,
      timeOrigin + utils.msToSec(entry.requestStart ),
      timeOrigin + utils.msToSec(entry.responseEnd ),
      {
        op: 'browser',
        name: 'request',
        attributes: {
    ...
    utils.startAndEndSpan(
      span,
      timeOrigin + utils.msToSec(entry.responseStart ),
      timeOrigin + utils.msToSec(entry.responseEnd ),
      {
        op: 'browser',
        name: 'response',
